...
export default function Step1(props) {
    ...
    const [salaryDate, setSalaryDate] = React.useState(new Date().toISOString());
    let inputValues = {
        existingLoans,
        employmentType,
        pay,
    ...
    const handleSalaryDate = (event) => {
        ...
        onInputChange(inputValues);
        setSalaryDate(new Date(event._d).toISOString());
    }
            ...
            <div style={{ textAlign: "center" }}>
                <div style={{ display: "inline-block", margin: "0 auto", width: "fit-content" }}>
                    <div style={{ float: "left", width: "100px", marginRight: "35px" }}>
                        <Card style={{ margin: "0px", marginRight: "20px", width: "fit-content", cursor: "pointer" }}>
                            <CardBody style={{ padding: "10px", width: "fit-content" }}>
                                <img onClick={() => handleEmploymentType("paid")} src={employed} style={{ width: "70px", height: "70px" }} />
                            </CardBody>
                        </Card>
                    ...
                    <div style={{ float: "left", width: "100px", marginRight: "35px" }}>
                        <Card style={{ margin: "0px", marginRight: "20px", width: "fit-content", cursor: "pointer" }}>
                            <CardBody style={{ padding: "10px", width: "fit-content" }}>
                                <img onClick={() => handleEmploymentType("self")} src={paid} style={{ width: "70px", height: "70px" }} />
                            </CardBody>
                        </Card>
                    ...
                    <div style={{ float: "left", width: "100px", marginRight: "35px" }}>
                        <Card style={{ margin: "0px", marginRight: "20px", width: "fit-content", cursor: "pointer" }}>
                            <CardBody style={{ padding: "10px", width: "fit-content" }}>
                                <img onClick={() => handleEmploymentType("corporate")} src={corporate} style={{ width: "70px", height: "70px" }} />
                            </CardBody>
                        </Card>
