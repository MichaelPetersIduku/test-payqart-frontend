...
export default function Step2(props) {
    ...
    const { onInputChange, inputValues, paymentData, updateBreakDown } = props;
    let downPayment = 0;
                        ...
                        <Card style={{ margin: "0px", marginRight: "20px", width: "90px", cursor: "pointer", borderTop: "10px solid red" }}>
                            <CardBody style={{ width: "100%", padding: "0px" }}>
                                <div onClick={() => handleMonths(1)} style={{ color: month1Color.color, background: month1Color.background, borderBottomLeftRadius: "6px", borderBottomRightRadius: "6px", }}>
                                    ...
                                    <Typography style={{ marginBottom: "0px" }} variant="h3" component="h4" gutterBottom>
                                        1
                                    </Typography>
                                    <span>month</span>
                                </div>
                ...
                <CardBody>
                    <GridContainer>
                        ...
                        <GridItem xs={12} sm={12} md={12} lg={5}>
                            <div style={{ color: "white", borderRadius: "7px", padding: "10px", position: "absolute", top: '-15px', width: "92%", height: "111%", background: "#f50057", textAlign: "center" }}>
                                <p style={{ fontSize: "19px", marginTop: "5px", marginBottom: "5px" }}>Customize Down Payment</p>
                                <Paper component="form" style={{ width: "100%", height: "37px", marginBottom: "10px" }} className={classes.root}>
